...
public class MainActivity extends AppCompatActivity {
    ...
    private void mostrarDialogGestionMapeosPorVista(){
        ...
        TextView titulo = new TextView(this); titulo.setText("⚡ MULTIVISTAS + PRECARGA 20px"); titulo.setTextSize(15); titulo.setTextColor(0xFF8f6bc0); titulo.setPadding(0,0,0,12); layout.addView(titulo);
        ...
        new AlertDialog.Builder(this).setTitle("⚡ MULTIVISTAS").setView(layout)
