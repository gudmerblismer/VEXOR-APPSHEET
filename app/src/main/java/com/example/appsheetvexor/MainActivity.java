...
public class MainActivity extends AppCompatActivity {
    ...
    private void mostrarDialogGestionMapeosPorVista(){
        ...
        TextView titulo = new TextView(this); titulo.setText("🗺 MAPEOS POR VISTA - ILIMITADO"); titulo.setTextSize(15); titulo.setTextColor(0xFF8f6bc0); titulo.setPadding(0,0,0,12); layout.addView(titulo);
        ...
        EditText inputViewName = new EditText(this); inputViewName.setHint("VIEW NAME exacto (ej: TAVES 5, DATA STUDIO)");
