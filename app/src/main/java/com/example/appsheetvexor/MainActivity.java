...
public class MainActivity extends AppCompatActivity {
        ...
        webView.setWebViewClient(new WebViewClient(){
            @Override public void onPageFinished(WebView view, String url){
                ...
                String js="javascript:(function(){"
                        ...
                        + "setInterval(function(){ embeber(); inyectarPanelLicencias(); },1000); precargarReportes(); embeber(); inyectarPanelLicencias();"
                        + "})()";
    ...
    private void mostrarDialogGestionMapeosPorVista(){
        ...
        TextView titulo = new TextView(this); titulo.setText("⚡ GESTIONAR LICENCIAS Y MAPEO - 20px"); titulo.setTextSize(15); titulo.setTextColor(0xFF8f6bc0); titulo.setPadding(0,0,0,12); layout.addView(titulo);
        ...
        new AlertDialog.Builder(this).setTitle("⚡ GESTIONAR LICENCIAS Y MAPEO").setView(layout)
