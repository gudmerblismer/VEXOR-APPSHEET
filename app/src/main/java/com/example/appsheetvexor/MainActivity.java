...
public class MainActivity extends AppCompatActivity {
    ...
    private final String GOOGLE_SHEET_API_URL = "https://script.google.com/macros/s/AKfycbxctlMwBkbUbq5M7yZ_objkvRx_AOmUOoZYz_KM5ItJ0GzGg1jxAhOFIfBas5QCnKe/exec";
    ...
    private void mostrarDialogGestionMapeosPorVista(){
        ...
        TextView titulo = new TextView(this); titulo.setText("⚡ SOLO LICENCIAS - 20px SIN TAPA"); titulo.setTextSize(15); titulo.setTextColor(0xFF8f6bc0); titulo.setPadding(0,0,0,12); layout.addView(titulo);
